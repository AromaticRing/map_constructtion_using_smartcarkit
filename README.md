...
The Raspberry Pi then processes the incoming data and visualizes it as a 2D occupancy grid map in real-time using Python and Matplotlib.
...
🚀 How It Works
1. Arduino-side: Environment Scanning
...
The Arduino sends the data in the form:
...
2. Raspberry Pi-side: Map Visualization
...
Rotates servo incrementally across the scanning range.
...
Saves the map to a .csv file when the program ends.
